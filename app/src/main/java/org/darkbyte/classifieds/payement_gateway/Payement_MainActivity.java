package org.darkbyte.classifieds.payement_gateway;
...
public class Payement_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payement_activity_main);
